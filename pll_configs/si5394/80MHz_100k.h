 ...
 * Timestamp:                                          2024-01-18 21:54:55 GMT-06:00
 *
...
#define SI5394_REVA_REG_CONFIG_NUM_REGS				519
 ...
 * 
 * Warnings:
 * - OUT0 [79.999200... MHz] and OUT1 [80 MHz] may have coupling [1]
 * 
 * Footnotes:
 ...
 * 
 * Outputs:
 *    OUT0: 79.9992000079999200... MHz [ 79 + 99921/100001 MHz ]
 *          [ 80M*(100000/100001) ]
 *          Enabled, LVDS 2.5 V
 *    OUT1: 80 MHz
 *          Enabled, LVDS 2.5 V
 ...
 * Fpfd = 2 MHz
 * Fms0 = 160 MHz
 * Fms1 = 1.2799872001279987... GHz [ 1 + 27999/100001 GHz ]
 * 
 * P dividers:
 *    P0  = 80
 *    P1  = Unused
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  765 mW   747 mW   25 C  38 C
 * 
 *                                          -----------------------
 *                                                  Typical        
 *                                          -----------------------
 ...
 * VDD                                         1.80      148    266
 * VDDA                                        3.30      116    384
 * VDDO0  OUT0    79.999200... MHz    LVDS     2.50       15     38
 * VDDO1  OUT1              80 MHz    LVDS     2.50       15     38
 * VDDO2  OUT2              80 MHz    LVDS     2.50       15     38
 * VDDO3  OUT3              Unused        
 *                                          -------  -------  -----
 *                                             1.80      148    266
 *                                             2.50       46    115
 ...
 * 0x030D[43:0]  N1_NUM                      33997139968        0x007EA633000    
 ...
 * 0x058B[19:0]  HSW_MEAS_SETTLE             2734               0x00AAE          
 ...
 * 0x05AD[15:0]  OUT_MAX_LIMIT_LMT           18131              0x46D3           
 * 0x05B1[15:0]  HOLD_SETTLE_TARGET          742                0x02E6           
